...
public enum Scent {
    ...
    public static final List<Scent> SCENT_MAPPING = Arrays.asList(TOP_AQUAL, TOP_BERGAMOT, TOP_MINT, TOP_LEMON, TOP_GRAPEFRUIT, TOP_PEACH, TOP_THYME, TOP_FIG, TOP_BLACKCHERRY, TOP_GREEN,
